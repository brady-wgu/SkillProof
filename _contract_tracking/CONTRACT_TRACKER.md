...
**Storyboard baseline:** brady-wgu/JFT_SDP at v4.37
...
| A-9.14 | Self-service support portal | Yes | Gap | Not Started | JFT | Self-service portal scoped + delivered | |
| A-9.15 | Video training resources | Yes | Gap | Not Started | JFT | Video modules per audience in support library | |
...
The following Appendix A rows have Storyboard Coverage = Gap and are first-priority candidates for prototype gap closure (after v4.37 re-audit):
...
|:---|:---|:---|:---|
| 1.0 | 12 May 2026 | Current | Initial baseline. 156 rows enumerated across MSA + SOW + Appendix A. 9 gaps identified for D3a follow-up. Storyboard baseline: v4.37. |
