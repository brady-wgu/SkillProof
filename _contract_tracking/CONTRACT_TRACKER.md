...
| A-7.10 | Comprehensive student engagement tracking | Yes | tenant-24 (Engagement section: time-on-task chart + submissions trend) · instructor-02..instructor-08 · student-06 progress map | In Dev | JFT | Engagement dashboards live for educators | v4.51 closed Tenant Admin coverage gap. FERPA-bounded per A-10.1. |
| A-7.11 | Learning analytics dashboard for educators | Yes | tenant-24 (Class Insights section: subject summary + at-risk badges + drill-down) · instructor-02..instructor-08 | In Dev | JFT | Class-wide insights + at-risk flagging + drill-down | v4.51 closed Tenant Admin coverage gap. |
| A-7.12 | Usage statistics and reporting | Yes | tenant-24 (Program Reports section: filters + Engagement / Submissions / Topic-Mastery reports) · super-03 token usage · instructor-02 KPIs | In Dev | JFT | Usage reports filterable + exportable | v4.51 closed Tenant Admin coverage gap. |
| A-7.13 | Data visualization tools | Yes | tenant-24 (accessible SVG charts in Engagement section) · instructor-03 heatmap · super-02 KPI gauges · super-04 cost chart | In Dev | JFT | Charts accessible (screen reader, hover context) | v4.51 added Tenant Admin coverage. |
| A-7.14 | Export capabilities for all reports | Yes | tenant-24 (Program Reports: CSV / PDF / JSON per report row) · instructor-03 PDF/CSV CTAs | In Dev | JFT | CSV / PDF / JSON / XML one-click exports | v4.51 closed Tenant Admin coverage gap. XML added per v4.18 (§16.3 #8.9 alignment). |
...
| A-10.4 | Audit logging for all data access and modifications | Yes | tenant-25 (tenant-scoped Activity Log) · super-08 (cross-tenant audit log) · instructor-08 (audit trail) · tenant-23 (audit ref) | In Dev | JFT | Immutable audit logs for read/write actions | v4.51 added tenant-scoped view. |
